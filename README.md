...
面向 Windows 10 的 Codex Computer Use 截图兼容层。项目构建一个本地加载的 x64 `version.dll`，为现有 Computer Use helper 补充缺失的捕获边框接口，并调整截图回调的执行线程。
...
- [本机跨应用验证记录](capture-compat/docs/local-validation-2026-09-12.md)
